...
// @access  Private
router.post('/', [auth, checkPermission('settings', 'full')], async (req, res) => {
    const { name, code, address, status, phone, email, type, manager } = req.body;
    if (!name || !code) {
...
// @access  Private
router.put('/:id', [auth, checkPermission('settings', 'full')], async (req, res) => {
    const { name, code, address, status, phone, email, type, manager } = req.body;
...
// @access  Private
router.delete('/:id', [auth, checkPermission('settings', 'full')], async (req, res) => {
    try {
